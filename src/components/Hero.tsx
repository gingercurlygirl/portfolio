    ...
    <section className="mx-auto flex max-w-5xl flex-col items-center px-6 pt-24 pb-8 md:flex-row md:gap-16 md:text-left">
      ...
      <div className="flex flex-col items-center md:items-start">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 md:justify-start">
          ...
          <a href="/ivana_lovric_cv_svenska.pdf" download className="flex items-center gap-2 rounded-lg border border-accent px-6 py-3 text-sm font-medium text-foreground transition-colors hover:border-foreground">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M12 16l-5-5h3V4h4v7h3l-5 5zm-7 2h14v2H5v-2z"/></svg>
            Download CV
          </a>
        </div>
      </div>
